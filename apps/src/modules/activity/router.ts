...
export class ActivityRouter {
    ...
    get routes() {
        ...
        this.activityRouter.get(
            '/:id',
            this.activityMiddleware.getActivityById,
        );
        this.activityRouter.post('/', this.activityMiddleware.postActivity);
        this.activityRouter.patch(
            '/:id',
            this.activityMiddleware.patchActivity,
        );
        this.activityRouter.delete(
            '/:id',
            this.activityMiddleware.deleteActivity,
        );
